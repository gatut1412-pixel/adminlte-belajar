...
{{--                <button type="button" class="btn-sm btn-primary float-right" data-toggle="modal" data-target="#modal-add">Tambah</button>--}}
                <a href="{{route('tambahsoal.create')}}" class="btn btn-sm btn-primary float-md-right">Tambah</a>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                <div class="row">
                    <div class="col-sm-12">
                        <table id="soal" class="table table-bordered table-striped table-hover"
                            ...
                            @foreach($soal as $pertanyaan)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('tambahsoal.edit', $pertanyaan->id) }}" class="btn btn-sm btn-primary"><i class="fas fa-pen-square" aria-hidden="true" title="Edit"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
